        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            <div className="relative mb-8 blob-float">
              ...
              <img src="/bob/BOB_dumbfounded.gif" alt="The Church of B.O.B." className="relative w-40 h-40 md:w-52 md:h-52 rounded-full object-cover border-4 border-white/80 shadow-2xl group-hover:scale-105 transition-transform duration-500" />
            </div>
