...
import { BobInitiation } from '../components/BobInitiation';
...
const navLinks = [
  ...
  { href: "#bob-trials", label: "Goo Trials" },
  { href: "#bob-initiation", label: "Initiation" },
    ...
    <div style={bgStyle} className="min-h-screen font-sans text-white selection:bg-[#6C7AE0] selection:text-white page-transition-enter">
      <div className="flex flex-col lg:flex-row relative">
        ...
        <main className="flex-1 min-w-0 overflow-hidden">
          ...
          {/* Goo Trials — minigames teaser */}
          <BobSection id="bob-trials">
            <h2 className="display-font text-3xl md:text-4xl mb-4 text-[#9AA9FF]">The Goo Trials</h2>
            <p className="text-lg md:text-xl mb-8 leading-relaxed" style={{ color: text }}>
              How brainless are you, really? Prove your blankness in the sacred minigames of the Church. Defend the goo, sort snacks from thoughts, hold the stare, transcribe the scriptures, and float through the pillars of thought.
            </p>
            <Link to="/games" className="text-[#9AA9FF] hover:text-white font-bold uppercase tracking-widest text-sm transition-colors border border-[#6C7AE0]/50 hover:border-[#9AA9FF] px-6 py-3 rounded-lg inline-block hover:bg-[#6C7AE0]/20">
              Enter the Goo Trials →
            </Link>
          </BobSection>

          {/* Initiation */}
          <BobSection id="bob-initiation">
            <BobInitiation />
          </BobSection>
